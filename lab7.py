...
class GraphicsEditor2D:
    ...
    def on_enter_press(self, event):
        if self.correction_mode:
            ...
            self.canvas.delete("ghost")
                ...
                self.mode_combobox.get() == "Delone triangulation"
            ...
            return
                ...
                self.mode_combobox.get() == "Voronoi diagram"
                and self.current_line != None
                and len(self.current_line) >= 3
        ):
    ...
    def create_mode_menu(self):
        ...
        self.mode_combobox = ttk.Combobox(
            self.window,
            values=["Delone triangulation", "Voronoi diagram"]
        )
    ...
    def on_canvas_click(self, event):
        ...
        if self.current_line is None:
            self.current_line = [x_center, y_center]
                ...
                (self.mode_combobox.get() == "Curve")
                or (self.mode_combobox.get() == "Polygon")
                or (self.mode_combobox.get() == "Delone triangulation")
                or (self.mode_combobox.get() == "Voronoi diagram")
        ):
